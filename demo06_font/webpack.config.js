                ...
                use: [
                    {
                        ...
                        options: {
                            ...
                            publicPath: "../common/fonts/", // 设置资源文件的引用根路径
                            outputPath: "common/fonts/" // publicPath/outputPath/[name].[ext]
                        }
                    }
                ]
            },
                ...
                use: [
                    {
                        ...
                        options: {
                            limit: 15360, // size <= 15KB, 改成15257(<14.9KB)试试?
                            name: "[name]-[hash:5].min.[ext]", // 设置文件名(>limit的情况)
                            publicPath: "../common/images/", // 设置资源文件的引用根路径
                            outputPath: "common/images/" // publicPath/outputPath/[name].[ext]
                        }
                    }
                ]
            }
